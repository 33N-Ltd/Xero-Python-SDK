...
class Schedule(object):
    ...
    def __init__(self, period=None, unit=None, due_date=None, due_date_type=None, start_date=None, next_scheduled_date=None, end_date=None):  # noqa: E501
    ...
    def due_date_type(self, due_date_type):
        ...
        :type: str
        """
        allowed_values = ["DAYSAFTERBILLDATE", "DAYSAFTERBILLMONTH", "OFCURRENTMONTH", "OFFOLLOWINGMONTH"]  # noqa: E501
        if due_date_type not in allowed_values:
            raise ValueError(
                "Invalid value for `due_date_type` ({0}), must be one of {1}"  # noqa: E501
