...
class TaxRate(object):
    ...
    def __init__(self, name=None, tax_type=None, tax_components=None, status=None, report_tax_type=None, can_apply_to_assets=None, can_apply_to_equity=None, can_apply_to_expenses=None, can_apply_to_liabilities=None, can_apply_to_revenue=None, display_tax_rate=None, effective_rate=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["ACTIVE", "DELETED", "ARCHIVED"]  # noqa: E501
    ...
    def report_tax_type(self, report_tax_type):
        ...
        :type: str
        """
        if report_tax_type is None:
            raise ValueError("Invalid value for `report_tax_type`, must not be `None`")  # noqa: E501
        allowed_values = ["OUTPUT", "INPUT", "EXEMPTOUTPUT", "INPUTTAXED", "BASEXCLUDED", "EXEMPTEXPENSES", "EXEMPTINPUT", "ECOUTPUT", "ECOUTPUTSERVICES", "ECINPUT", "ECACQUISITIONS", "CAPITALSALESOUTPUT", "CAPITALEXPENSESINPUT", "MOSSSALES", "NONE", "GSTONIMPORTS"]  # noqa: E501
        if report_tax_type not in allowed_values:
            raise ValueError(
                "Invalid value for `report_tax_type` ({0}), must be one of {1}"  # noqa: E501
