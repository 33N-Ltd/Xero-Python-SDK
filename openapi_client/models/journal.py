...
class Journal(object):
    ...
    def __init__(self, journal_id=None, journal_date=None, journal_number=None, created_date_utc=None, reference=None, source_id=None, source_type=None, journal_lines=None):  # noqa: E501
