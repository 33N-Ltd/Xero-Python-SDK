...
class RepeatingInvoice(object):
    ...
    def __init__(self, type=None, contact=None, schedule=None, line_items=None, line_amount_types=None, reference=None, branding_theme_id=None, currency_code=None, status=None, sub_total=None, total_tax=None, total=None, repeating_invoice_id=None, id=None, has_attachments=None, attachments=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["DRAFT", "AUTHORISED"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RepeatingInvoice):
            return False
