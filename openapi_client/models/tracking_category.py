...
class TrackingCategory(object):
    ...
    def __init__(self, tracking_category_id=None, tracking_option_id=None, name=None, option=None, status=None, options=None):  # noqa: E501
    ...
    def option(self, option):
        ...
        if option is not None and len(option) > 100:
            raise ValueError("Invalid value for `option`, length must be less than or equal to `100`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TrackingCategory):
            return False
