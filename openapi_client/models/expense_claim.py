...
class ExpenseClaim(object):
    ...
    def __init__(self, expense_claim_id=None, status=None, payments=None, user=None, receipts=None, updated_date_utc=None, total=None, amount_due=None, amount_paid=None, payment_due_date=None, reporting_date=None, receipt_id=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["SUBMITTED", "AUTHORISED", "PAID", "VOIDED"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ExpenseClaim):
            return False
