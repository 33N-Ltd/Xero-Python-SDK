...
class PaymentService(object):
    ...
    def __init__(self, payment_service_id=None, payment_service_name=None, payment_service_url=None, pay_now_text=None, payment_service_type=None, validation_errors=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PaymentService):
            return False
