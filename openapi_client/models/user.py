...
class User(object):
    ...
    def __init__(self, user_id=None, email_address=None, first_name=None, last_name=None, updated_date_utc=None, is_subscriber=None, organisation_role=None):  # noqa: E501
    ...
    def organisation_role(self, organisation_role):
        ...
        :type: str
        """
        allowed_values = ["READONLY", "INVOICEONLY", "STANDARD", "FINANCIALADVISER", "MANAGEDCLIENT", "CASHBOOKCLIENT"]  # noqa: E501
        if organisation_role not in allowed_values:
            raise ValueError(
                "Invalid value for `organisation_role` ({0}), must be one of {1}"  # noqa: E501
