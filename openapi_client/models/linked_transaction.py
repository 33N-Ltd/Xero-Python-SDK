...
class LinkedTransaction(object):
    ...
    def __init__(self, source_transaction_id=None, source_line_item_id=None, contact_id=None, target_transaction_id=None, target_line_item_id=None, linked_transaction_id=None, status=None, type=None, updated_date_utc=None, source_transaction_type_code=None, validation_errors=None):  # noqa: E501
    ...
    def source_line_item_id(self, source_line_item_id):
        ...
        :type: str
        """
        if source_line_item_id is None:
            raise ValueError("Invalid value for `source_line_item_id`, must not be `None`")  # noqa: E501
    ...
    def source_transaction_type_code(self, source_transaction_type_code):
        ...
        if source_transaction_type_code not in allowed_values:
            raise ValueError(
                "Invalid value for `source_transaction_type_code` ({0}), must be one of {1}"  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LinkedTransaction):
            return False
