...
class ManualJournal(object):
    ...
    def __init__(self, narration=None, journal_lines=None, date=None, line_amount_types=None, status=None, url=None, show_on_cash_basis_reports=None, has_attachments=None, updated_date_utc=None, manual_journal_id=None, warnings=None, validation_errors=None, attachments=None):  # noqa: E501
    ...
    def status(self, status):
        ...
        :type: str
        """
        allowed_values = ["DRAFT", "POSTED", "DELETED", "VOIDED"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManualJournal):
            return False
