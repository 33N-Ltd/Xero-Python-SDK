...
class JournalLine(object):
    ...
    def __init__(self, journal_line_id=None, account_id=None, account_code=None, account_type=None, account_name=None, description=None, net_amount=None, gross_amount=None, tax_amount=None, tax_type=None, tax_name=None, tracking_categories=None):  # noqa: E501
