...
class ManualJournalLine(object):
    ...
    def __init__(self, line_amount=None, account_code=None, description=None, tax_type=None, tracking=None, tax_amount=None, is_blank=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ManualJournalLine):
            return False
