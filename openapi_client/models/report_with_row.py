...
class ReportWithRow(object):
    ...
    def __init__(self, report_id=None, report_name=None, report_title=None, report_type=None, report_titles=None, report_date=None, updated_date_utc=None, rows=None, fields=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportWithRow):
            return False
