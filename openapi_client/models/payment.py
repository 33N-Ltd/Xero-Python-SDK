...
class Payment(object):
    ...
    def __init__(self, invoice=None, credit_note=None, prepayment=None, overpayment=None, invoice_number=None, credit_note_number=None, account=None, code=None, date=None, currency_rate=None, amount=None, reference=None, is_reconciled=None, status=None, payment_type=None, updated_date_utc=None, payment_id=None, bank_account_number=None, particulars=None, details=None, has_account=None, has_validation_errors=None, validation_errors=None):  # noqa: E501
