...
class BatchPaymentDetails(object):
    ...
    def __init__(self, bank_account_number=None, bank_account_name=None, details=None, code=None, reference=None):  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BatchPaymentDetails):
            return False
