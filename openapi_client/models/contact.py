...
class Contact(object):
    ...
    openapi_types = {
        ...
        'sales_tracking_categories': 'list[TrackingCategory]',
        'purchases_tracking_categories': 'list[TrackingCategory]',
    ...
    def __init__(self, contact_id=None, contact_number=None, account_number=None, contact_status=None, name=None, first_name=None, last_name=None, email_address=None, skype_user_name=None, contact_persons=None, bank_account_details=None, tax_number=None, accounts_receivable_tax_type=None, accounts_payable_tax_type=None, addresses=None, phones=None, is_supplier=None, is_customer=None, default_currency=None, xero_network_key=None, sales_default_account_code=None, purchases_default_account_code=None, sales_tracking_categories=None, purchases_tracking_categories=None, tracking_category_name=None, tracking_category_option=None, payment_terms=None, updated_date_utc=None, contact_groups=None, website=None, branding_theme=None, batch_payments=None, discount=None, balances=None, attachments=None, has_attachments=None, validation_errors=None, has_validation_errors=None):  # noqa: E501
    ...
    def contact_number(self, contact_number):
        ...
        if contact_number is not None and len(contact_number) > 50:
            raise ValueError("Invalid value for `contact_number`, length must be less than or equal to `50`")  # noqa: E501
    ...
    def contact_status(self, contact_status):
        ...
        if contact_status not in allowed_values:
            raise ValueError(
                "Invalid value for `contact_status` ({0}), must be one of {1}"  # noqa: E501
    ...
    def tax_number(self, tax_number):
        ...
        if tax_number is not None and len(tax_number) > 50:
            raise ValueError("Invalid value for `tax_number`, length must be less than or equal to `50`")  # noqa: E501
