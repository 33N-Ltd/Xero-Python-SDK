...
class Invoice(object):
    ...
    def __init__(self, type=None, contact=None, line_items=None, date=None, due_date=None, line_amount_types=None, invoice_number=None, reference=None, branding_theme_id=None, url=None, currency_code=None, currency_rate=None, status=None, sent_to_contact=None, expected_payment_date=None, planned_payment_date=None, sub_total=None, total_tax=None, total=None, total_discount=None, invoice_id=None, has_attachments=None, is_discounted=None, payments=None, prepayments=None, overpayments=None, amount_due=None, amount_paid=None, fully_paid_on_date=None, amount_credited=None, updated_date_utc=None, credit_notes=None, attachments=None, has_errors=None, status_attribute_string=None, validation_errors=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        allowed_values = ["ACCREC", "ACCPAY"]  # noqa: E501
