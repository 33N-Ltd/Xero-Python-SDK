...
class Account(object):
    ...
    def __init__(self, code=None, name=None, account_id=None, type=None, bank_account_number=None, status=None, description=None, bank_account_type=None, currency_code=None, tax_type=None, enable_payments_to_account=None, show_in_expense_claims=None, _class=None, system_account=None, reporting_code=None, reporting_code_name=None, has_attachments=None, updated_date_utc=None, validation_errors=None):  # noqa: E501
    ...
    def bank_account_type(self, bank_account_type):
        ...
        :type: str
        """
        allowed_values = ["BANK", "CREDITCARD", "PAYPAL", ""]  # noqa: E501
    ...
    def system_account(self, system_account):
        ...
        :type: str
        """
        allowed_values = ["DEBTORS", "CREDITORS", "BANKCURRENCYGAIN", "GST", "GSTONIMPORTS", "HISTORICAL", "REALISEDCURRENCYGAIN", "RETAINEDEARNINGS", "ROUNDING", "TRACKINGTRANSFERS", "UNPAIDEXPCLM", "UNREALISEDCURRENCYGAIN", "WAGEPAYABLES", ""]  # noqa: E501
        if system_account not in allowed_values:
            raise ValueError(
                "Invalid value for `system_account` ({0}), must be one of {1}"  # noqa: E501
