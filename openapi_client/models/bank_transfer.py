...
class BankTransfer(object):
    ...
    def __init__(self, from_bank_account=None, to_bank_account=None, amount=None, date=None, bank_transfer_id=None, currency_rate=None, from_bank_transaction_id=None, to_bank_transaction_id=None, has_attachments=None, created_date_utc=None, validation_errors=None):  # noqa: E501
    ...
    def from_bank_account(self, from_bank_account):
        ...
        if from_bank_account is None:
            raise ValueError("Invalid value for `from_bank_account`, must not be `None`")  # noqa: E501
    ...
    def to_bank_account(self, to_bank_account):
        ...
        if to_bank_account is None:
            raise ValueError("Invalid value for `to_bank_account`, must not be `None`")  # noqa: E501
