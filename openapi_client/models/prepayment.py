...
class Prepayment(object):
    ...
    def __init__(self, type=None, contact=None, date=None, status=None, line_amount_types=None, line_items=None, sub_total=None, total_tax=None, total=None, updated_date_utc=None, currency_code=None, prepayment_id=None, currency_rate=None, remaining_credit=None, allocations=None, has_attachments=None, attachments=None):  # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["RECEIVE-PREPAYMENT", "SPEND-PREPAYMENT"]  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Prepayment):
            return False
